...
type Order struct {
	...
	Status         int8       `gorm:"type:tinyint;not null;default:1;index:idx_orders_status;index:idx_orders_created_at_status,priority:2" json:"status"`
	...
	CreatedAt      time.Time  `gorm:"type:datetime;not null;default:CURRENT_TIMESTAMP;index:idx_orders_user_id_created_at,priority:2;index:idx_orders_created_at_status,priority:1" json:"created_at"`
